...
def main():
    ...
    if data_args.task_name is not None:
        ...
        if raw_datasets['test'] is None:
            train = raw_datasets['train'].train_test_split(test_size=0.2)
    ...
    def preprocess_function(examples):
        ...
        #result = tokenizer(*args, padding=padding, max_length=max_seq_length, truncation='only_first')
    ...
    def compute_metrics(p: EvalPrediction):
        ...
        if data_args.task_name is not None:
            ...
            #return {"accuracy": (preds == p.label_ids).astype(np.float32).mean().item(), metric.compute(predictions=preds, references=p.label_ids, average="macro")}
